...
import com.example.gatar.Spizarka.Fragments.Change.ChangeButtonActualizeItemFragment;
import com.example.gatar.Spizarka.Fragments.Change.ChangeButtonAddNewItemFragment;
import com.example.gatar.Spizarka.Fragments.Change.ChangeButtonDecreaseQuantityFragment;
import com.example.gatar.Spizarka.Fragments.Change.ChangeButtonIncreaseQuantityFragment;
 ...
 * {@link ChangeButtonActualizeItemFragment}
...
public class ChangeActivity extends AppCompatActivity implements
        ...
        ChangeButtonActualizeItemFragment.ChangeActualizeButtonFragmentListener,
    ...
    private void setActualizeButton(){
        FragmentTransaction fragmentTransaction = this.fragmentManager.beginTransaction();
        this.currentButtonFragment = new ChangeButtonActualizeItemFragment();
        fragmentTransaction.replace(R.id.change_button_container,this.currentButtonFragment);
        fragmentTransaction.addToBackStack(null);
        fragmentTransaction.commit();
    }
